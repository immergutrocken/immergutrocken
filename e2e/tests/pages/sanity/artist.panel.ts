...
class SectionLanguages extends Panel {
  public readonly german: SectionLanguage = new SectionLanguage(
    this.root,
    "de"
  );
  public readonly sectionEnglish: SectionLanguage = new SectionLanguage(
    this.root,
    "en"
  );
...
class SectionLanguage extends Panel {
  public readonly banner: SectionBanner = new SectionBanner(
    this.root,
    this._language
  );
  public readonly textBoxContent: TextBoxContent = new TextBoxContent(
    this.root,
    this._language
  );
  ...
  public get inptTitle(): Locator {
    return this.root
      .getByTestId("field-languages.de.title")
      .getByTestId("string-input");
  }

  public get inptSubtitle(): Locator {
    return this.root
      .getByTestId("field-languages.de.subtitle")
      .getByTestId("string-input");
  }
}
...
class SectionBanner extends Panel {
  ...
  public get root(): Locator {
    return this._parentLocator.locator('fieldset[data-level="3"]', {
      hasText: "Banner",
    });
  }
  ...
  public get inptCaption(): Locator {
    return this.root
      .getByTestId(`field-languages.${this._language}.banner.caption`)
      .getByTestId("string-input");
  }

  public get inptAlt(): Locator {
    return this.root
      .getByTestId(`field-languages.${this._language}.banner.alt`)
      .getByTestId("string-input");
  }

  public get inptCredits(): Locator {
    return this.root
      .getByTestId(`field-languages.${this._language}.banner.credits`)
      .getByTestId("string-input");
  }
}

class TextBoxContent extends Panel {
  public readonly overlayYouTube: OverlayYouTube = new OverlayYouTube(
    this.root
  );
  public readonly overlayBildergalerie: OverlayBildergalerie =
    new OverlayBildergalerie(this.root);

  constructor(
    parentLocator: Locator,
    private _language: "en" | "de"
  ) {
    super(parentLocator);
  }

  public get root(): Locator {
    return this._parentLocator.getByTestId(
      `field-languages.${this._language}.content`
    );
  }
  ...
  public get btnAddMedia(): Locator {
    return this.root
      .getByTestId("insert-menu-button")
      .locator('svg[data-sanity-icon="ellipsis-horizontal"]');
  }

  public get btnAddYoutube(): Locator {
    return this.root.getByRole("button", {
      name: "Insert YouTube Video (block)",
    });
  }
  ...
  public get btnAddMediaMenuEntryGalery(): Locator {
    return this.root
      .page()
      .locator('[data-ui="MenuButton__popover"]')
      .getByRole("menuitem", { name: "Insert Bildergalerie (block)" });
  }
}

class OverlayYouTube extends Panel {
  public get root(): Locator {
    return this._parentLocator
      .page()
      .locator(
        '[data-testid="document-panel-portal"] [data-testid="default-edit-object-dialog"]',
        { hasText: "Edit YouTube Video" }
      );
  }
...
class OverlayBildergalerie extends Panel {
  public readonly overlayEditBild: OverlayEditBild = new OverlayEditBild(
    this.root
  );
...
class OverlayEditBild extends Panel {
  public get root(): Locator {
    return this._parentLocator.page().locator('[role="dialog"]', {
      hasText: "Edit Bild",
      hasNotText: "Edit Bildergalerie",
    });
  }
  ...
  public get btnSelectMenuEntryUploadedImages(): Locator {
    return this.root
      .page()
      .locator('[data-ui="MenuButton__popover"]')
      .getByRole("menuitem", { name: "Uploaded Images" });
  }
